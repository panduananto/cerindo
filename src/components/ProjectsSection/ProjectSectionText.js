...
function ProjectSectionText({ title, totalShipment, description }) {
	return (
		<div className="col-span-12 space-y-4 divide-y divide-slate-200 p-4 text-center swiper-md:col-span-5 swiper-md:py-6 swiper-md:pr-0 swiper-md:pl-6 swiper-md:text-left">
