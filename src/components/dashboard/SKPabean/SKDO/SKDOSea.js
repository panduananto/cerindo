...
function SKDOSea({ shipment, importir, ppjk }) {
	let now = new Date()
		.toLocaleString('id', {
			year: 'numeric',
			month: 'short',
	...
	return (
		<div className="font-serif">
			<h3 className="mt-32 text-center text-base font-bold text-black underline">
					...
					<ol className="pl-4 pt-4">
						...
						<li>
							<div className="grid grid-cols-12">
								<p>B/L</p>
								<div className="col-span-7 col-start-3 flex justify-between">
									<p>: {shipment !== null ? shipment.bl : '__'}</p>
									<p>TGL : {shipment !== null ? formatDate(shipment.blDate) : '__'}</p>
								</div>
							</div>
						</li>
					</ol>
