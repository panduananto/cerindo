...
export const fetchAkl = createAsyncThunk(
	'aklsSearchSlice/fetchAkl',
...
export const { selectAll: selectAklsSearch, selectById: selectAklsSearchById } =
	aklsSearchAdapter.getSelectors((state) => state.aklsSearch);
